...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', dropout_rate=0,
    ...
    if netG == 'unet_256':
        ...
        net = UnetGenerator(input_nc, output_nc, 8, dropout_rate, ngf, norm_layer=norm_layer)
    elif netG == 'unet_deepest_256':
        from .modules.unet_architecture.unet_deepest_generator import UnetDeepestGenerator
        net = UnetDeepestGenerator(input_nc, output_nc, 8, dropout_rate, ngf, norm_layer=norm_layer)
        ...
        from .modules.resnet_architecture.mobile_resnet_deepest_generator import MobileResnetDeepestGenerator
...
def define_D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, gpu_ids=[], opt=None, n_share=3):
    ...
    if netD == 'n_layers':
        ...
        from models.modules.discriminators import MultiNLayerDiscriminator
        net = MultiNLayerDiscriminator(input_nc, n_share, ndf, norm_layer=norm_layer)
